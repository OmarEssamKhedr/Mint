...
public class AccountMenuTests extends BaseTest {
    ...
    public void testUserLogout() {
        ...
        AssertUtils.assertTrue(accountMenuPage.isOnHomePage(), "User should be on home page after login");

        // Access profile and logout
        accountMenuPage.clickValidUserProfile();
        WelcomePage returnedWelcomePage = accountMenuPage.logout();
    ...
    public void testProfileMenuAccess() {
        ...
        AssertUtils.assertTrue(accountMenuPage.isLogoutButtonVisible(), "Logout button should be visible in profile menu");
    }
    ...
    public void testDeleteAccountOptionAvailable() {
        ...
        AssertUtils.assertTrue(accountMenuPage.isDeleteAccountButtonVisible(),
    ...
    public void testProfileButtonDisplaysCorrectInitials() {
        ...
        AccountMenuPage accountMenuPage = new AccountMenuPage();
        AssertUtils.assertTrue(accountMenuPage.isOnHomePage(), "User should be on home page to see profile button");
        ...
        AssertUtils.assertTrue(accountMenuPage.isLogoutButtonVisible(),
    ...
    */
    ...
    public void testCompleteProfileNavigationFlow() {
        ...
        loginPage.loginWithValidCredentials();
        AccountMenuPage accountMenuPage = new AccountMenuPage();
        AssertUtils.assertTrue(accountMenuPage.isOnHomePage(), "Should reach home page after login");

        // Step 4: Access profile menu
        accountMenuPage.clickValidUserProfile();
        AssertUtils.assertTrue(accountMenuPage.isLogoutButtonVisible(), "Should access profile menu");
