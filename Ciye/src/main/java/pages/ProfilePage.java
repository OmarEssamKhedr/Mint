...
public class ProfilePage extends BasePage {
    ...
    private final By homeRoot = AppiumBy.xpath("/hierarchy/android.widget.FrameLayout");
    ...
    public ProfilePage clickValidUserProfile() {
    ...
    public ProfilePage clickDeleteUserProfile() {
    ...
    public ProfilePage clickDeleteAccount() {
    ...
    public ProfilePage enterDeleteConfirmationEmail(String email) {
